    ...
    switch (error.status) {
      case 404:
        return {
          ...
          message:
            '"Cette page est introuvable. Elle n’existe peut-être pas ou a été supprimée. Ou peut-être que c’est vous qui n’existez pas, et cette page n’a pas pu vous trouver.',
        };
      case 405:
        return {
